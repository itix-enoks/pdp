      ...
      OPCODE_OP: begin  // Register-Register ALU operation
        ...
        if (instr_rdata_i[14:12] == 3'b000 &&
            (instr_rdata_i[29:25] == 5'b10001 ||
             instr_rdata_i[29:25] == 5'b10011 ||
             instr_rdata_i[29:25] == 5'b10111)) begin
          alu_en             = 1'b1;
          regfile_alu_we     = 1'b1;
          rega_used_o        = 1'b1;
          regb_used_o        = 1'b1;
          if (instr_rdata_i[29:25] == 5'b10111) begin
            alu_operator_o = ALU_AES_COL;
          end else begin
